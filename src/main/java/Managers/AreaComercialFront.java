...
public class AreaComercialFront {
    ...
    public static void areaComercial(){
        ...
        do{
            ...
            switch (opcion) {
                case 1: AreaComercialBack.cargarCliente(); break;
    ...
    public static void clientes(){
        ...
        switch (opcion) {
           case 1: AreaComercialBack.actualizarDatosCliente(cliente); break;
           case 2: AreaComercialBack.bajaCliente(cliente); break;
           case 3: AreaComercialBack.eliminarCliente(cliente);break;
           case 4: AreaComercialBack.consultaCliente(cliente);break;
           case 5: areaComercial();break;
           case 6: ; break;
           default: System.out.println("Opción no válida. Por favor, elija una opción válida.");
        }
